...
export const CHAMPAGNE_SACRED_V2_MOTION_SCORE: HeroMotionScore = {
  ...
  durationSeconds: 42,
  layers: [
    { id: "sacred.motion.waveCaustics", opacity: 0.22, phaseSeconds: 0, blend: "screen" },
    { id: "sacred.motion.glassShimmer", opacity: 0.16, phaseSeconds: 7, blend: "screen" },
    { id: "sacred.motion.particleDrift", opacity: 0.14, phaseSeconds: 13, blend: "screen" },
    { id: "sacred.motion.goldDust", opacity: 0.18, phaseSeconds: 19, blend: "screen" },
  ],
  reducedMotion: "static-equivalent",
  autoplayFailure: "static-equivalent",
  collectiveRestartAllowed: false,
