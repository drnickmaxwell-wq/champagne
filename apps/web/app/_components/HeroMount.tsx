...
import type { HeroRendererV2Props } from "../components/hero/v2/HeroRendererV2.types";
import { HeroRendererV2 } from "../components/hero/v2/HeroRendererV2.server";
