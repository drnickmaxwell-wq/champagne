...
export function Atelier({ heroes }: { heroes: Record<AtelierPageKey, ReactNode> }) {
  ...
  }), [pageContract, page, viewport, persianChoice, porcelainChoice, current, closingPlacement, closingTreatment, instruction, proposals, decisions]);
