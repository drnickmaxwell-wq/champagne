...
export function Atelier() {
  ...
  const previewState = (time: StudioTime): AtelierPreviewState => ({ page, sections: current, selected, cleanPreview, time, brandDecision, canvasStyle, closingPlacement, closingTreatment, artDirections });
