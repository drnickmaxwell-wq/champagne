...
| --- | --- | --- | --- | --- | --- |
| 0 | ten superseded reviewed heads through `38b0e1db5b396410c43c7b4efa2a3dc2a8e5275a`; corrected phase head `bece39c70b72d37aa0dfdc567c97ea57c3b61db7` pending log commit and push | Baseline, initial HTML and disposable weakness reproduction; complete loaded-cascade ownership and parser hardening; actual export/layout emission validation; deterministic held-stylesheet browser proof across homepage/treatment, mobile/desktop, and reduced/normal motion. | all earlier static mutations fail; removed layout style fails the AST guard; stale critical snapshot fails exact early/final sRGB equality; strict matrix `8 passed`; complete Stage B `15 passed`; full `verify` pass; all mutations/artifacts restored | tenth corrected exact-head review pending | Both current P2s at `38b0e1db` corrected in `bece39c70b72d37aa0dfdc567c97ea57c3b61db7`; replacement review must be clean before Phase 1 |
