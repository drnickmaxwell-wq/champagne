...
| --- | --- | --- | --- | --- | --- |
| 0 | `c6cc6df5d8fc592bc83e27c178c0ecc9873d502b`, `35c154413c88d4fbaf39b1df81e79d56f395ac0f`, `4cdcd199933d844775f487ddc725029b5e4ea10a` and `3d5b7f79404b93c23afb250741029b26836d454d` (superseded); corrected phase head pending push | Baseline, initial HTML and disposable weakness reproduction; loaded structure, decoded identifiers/functions, self-contained color semantics, unconditional owner ancestry, and closed loaded import/ownership are all validated. | all earlier mutations plus `currentColor` and false-`@media` owner mutations fail with dedicated codes; mutations restored with no production-source diff; full `verify` pass; unchanged baseline Stage B `8 passed`; `3d5b7f` exact-head review completed | fifth corrected exact-head review pending | P1/P2 chain corrected through `03afc832ede6c2979880a3b5b807001bd713b4e8` |
