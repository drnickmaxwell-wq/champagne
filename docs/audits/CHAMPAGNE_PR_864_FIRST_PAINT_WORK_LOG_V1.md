...
| --- | --- | --- | --- | --- | --- |
| 0 | twelve superseded reviewed heads through `97a55e464f31f8f51110bb30eef484a8a6cc9e80`; corrected implementation commit `9ff46098815ccbb43cb316f87b479f5607966d90` pending log commit and push | Baseline, initial HTML and disposable weakness reproduction; complete loaded-cascade ownership and parser hardening; actual export/layout emission validation; deterministic held-stylesheet browser proof across homepage/treatment, mobile/desktop, and reduced/normal motion; readable canonical foreground with closed loaded-dependency ownership and exact early/final equality. | all earlier static mutations fail; removed layout style fails the AST guard; stale critical snapshot fails exact early/final canvas equality; later foreground override fails with `CANVAS_DEPENDENCY_OWNER_UNAPPROVED`; corrected strict Stage B-equivalent matrix `8 passed`; corrected full `verify` pass; disposable mutation worktree and browser artifacts removed | twelfth corrected exact-head review pending | The current P2 at `97a55e46` is corrected in `9ff46098815ccbb43cb316f87b479f5607966d90`; replacement review must be clean before Phase 1 |
