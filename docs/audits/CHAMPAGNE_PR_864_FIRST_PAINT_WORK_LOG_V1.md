...
| --- | --- | --- | --- | --- | --- |
| 0 | eleven superseded reviewed heads through `10de7bd2f15987d3004b8a280a48c9909faa613a`; corrected implementation commit `79db177594660c061e162e2a20188ea16235bc2b` pending log commit and push | Baseline, initial HTML and disposable weakness reproduction; complete loaded-cascade ownership and parser hardening; actual export/layout emission validation; deterministic held-stylesheet browser proof across homepage/treatment, mobile/desktop, and reduced/normal motion; readable canonical foreground while CSS is held. | all earlier static mutations fail; removed layout style fails the AST guard; stale critical snapshot fails exact early/final sRGB equality; corrected strict matrix `8 passed`; complete pre-correction Stage B `15 passed`; corrected full `verify` pass; all temporary artifacts restored | eleventh corrected exact-head review pending | The current P2 at `10de7bd` is corrected in `79db177594660c061e162e2a20188ea16235bc2b`; replacement review must be clean before Phase 1 |
