...
| --- | --- | --- | --- | --- | --- |
| 0 | eight superseded reviewed heads through `b61d2dc8f6da360df5b4e528a8bad62e53f04abc`; corrected phase head `97a9671d729228cf1d326e2774a28bc0fb73852b` pending log commit and push | Baseline, initial HTML and disposable weakness reproduction; loaded structure/imports, decoded identifiers/functions, AST declaration ownership across default and themed dependency chains, self-contained opaque color semantics including mix weights, unconditional owner ancestry, and genuine CSS function-token recognition are closed. | all earlier mutations plus downstream dependency overrides, translucent terminals/mixes, and whitespace-separated fake `var (` syntax fail with dedicated codes; mutations restored with no production-source diff; full `verify` pass; unchanged baseline Stage B `8 passed`; `b61d2dc` exact-head review completed | eighth corrected exact-head review pending | P1/P2 chain corrected through `97a9671d729228cf1d326e2774a28bc0fb73852b`; replacement review must be clean before Phase 1 |
